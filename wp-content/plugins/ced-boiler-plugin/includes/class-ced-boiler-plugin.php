...
class Ced_Boiler_Plugin
{
	...
	private function define_admin_hooks()
	{
		...
		$this->loader->add_action('admin_menu', $plugin_admin, 'Ced_new_menu'); //Adding New Menu
		$this->loader->add_action('add_meta_boxes', $plugin_admin, 'add'); //Adding Meta-Box For Brand
		$this->loader->add_action('save_post', $plugin_admin, 'save'); //Saving Meta-box Value for Brand
